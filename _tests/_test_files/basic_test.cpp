...
const vector<string> command_list = {
     ...
     /*08*/ "insert into employee values Smith,      \"Robert\",    CS,       90000,  2015", // Salary below 100k
     ...
     /*16*/ "insert into student values John,           \"Doe\",   Art,     21",
     /*17*/ "insert into student values Alice,          \"Wong\",  Physics, 24",
     /*18*/ "insert into student values Bob,            \"Smith\", Chemistry,19",
     ...
     // Edge cases
     /*38*/ "select * from student where age < 20",
     /*39*/ "select * from student where age > 100", // Invalid case: age > 100
     };

const int MAKE_TABLE_COMMANDS = 18;
const int SELECT_COMMANDS = 40;
...
//      /*19*/     "select * from student where (lname>J or fname=Bo) and (major=CS or major=Art)"
