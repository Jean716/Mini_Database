...
[  1%] Building CXX object CMakeFiles/main.dir/includes/tokenizer/stokenize.cpp.o
...
[ 37%] Building CXX object CMakeFiles/basic_test.dir/includes/tokenizer/stokenize.cpp.o
[ 39%] Linking CXX executable bin/basic_test
[ 60%] Built target basic_test
[ 62%] Building CXX object CMakeFiles/testB.dir/includes/table/table.cpp.o
[ 64%] Building CXX object CMakeFiles/testB.dir/includes/tokenizer/stokenize.cpp.o
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: make table employee fields  last,       first,         dep,      salary, year
...
Inserting field value: 2018 for field: year at index: 4Inserted into _indices[4]: (2018, 0)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into employee values Blow,       Joe,           CS,       100000, 2018
...
Field name: year
Field index for year: 4
Inserting field value: 2016 for field: year at index: 4Inserted into _indices[4]: (2016, 1)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into employee values Blow,       JoAnn,         Physics,  200000, 2016
...
Field name: year
Field index for year: 4
Inserting field value: 2014 for field: year at index: 4Inserted into _indices[4]: (2014, 2)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into employee values Johnson,    Jack,          HR,       150000, 2014
...
Field name: year
Field index for year: 4
Inserting field value: 2018 for field: year at index: 4Inserted into _indices[4]: (2018, 3)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into employee values Johnson,    "Jimmy",     Chemistry,140000, 2018
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: make table student fields  fname,          lname,    major,    age
...
Inserting field value: 20 for field: age at index: 3Inserted into _indices[3]: (20, 0)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into student values Flo,            Yao,       Art,    20
...
Field name: age
Field index for age: 3
Inserting field value: 28 for field: age at index: 3Inserted into _indices[3]: (28, 1)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into student values Bo,                     Yang,      CS,             28
...
Field name: age
Field index for age: 3
Inserting field value: 40 for field: age at index: 3Inserted into _indices[3]: (40, 2)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into student values "Sammuel L.", Jackson,     CS,             40
...
Field name: age
Field index for age: 3
Inserting field value: 27 for field: age at index: 3Inserted into _indices[3]: (27, 3)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into student values "Billy",        Jackson,   Math,   27
...
Field name: age
Field index for age: 3
Inserting field value: 30 for field: age at index: 3Inserted into _indices[3]: (30, 4)Current state of table: employee
Table name: employee
Records:
File name: employee.tbl
Records:
...
>>> Command executed successfully.
-------------Table ctor 1 Done!-----
Executed command: insert into student values "Mary Ann",   Davis,       Math,   30
...
Field map size:5
Field name: last
Field name (ASCII): 108 97 115 116 
Field map contents:
dep -> 2
first -> 1
last -> 0
...
Field map size:5
Field name: first
Field name (ASCII): 102 105 114 115 116 
Field map contents:
dep -> 2
first -> 1
last -> 0
...
Field map size:5
Field name: salary
Field name (ASCII): 115 97 108 97 114 121 
Field map contents:
dep -> 2
first -> 1
last -> 0
...
Field map size:5
Field name: year
Field name (ASCII): 121 101 97 114 
Field map contents:
dep -> 2
first -> 1
last -> 0
...
Field name: year
Field index for year: 4
Inserting field value: 2018 for field: year at index: 4Inserted into _indices[4]: (2018, 1)-------------------Table::vector_to_table done!----------------------------
Selected table:
Table name: _select_table_24
Records:
File name: employee_updated.tbl
Records:
...
Field map size:5
Field name: major
Field name (ASCII): 109 97 106 111 114 
Field map contents:
dep -> 2
first -> 1
last -> 0
...
Field map size:4
Field name: fname
Field name (ASCII): 102 110 97 109 101 
Field map contents:
age -> 3
fname -> 0
lname -> 1
...
Field map size:4
Field name: lname
Field name (ASCII): 108 110 97 109 101 
Field map contents:
age -> 3
fname -> 0
lname -> 1
...
Field name: age
Field index for age: 3
Inserting field value: 40 for field: age at index: 3Inserted into _indices[3]: (40, 2)-------------------Table::vector_to_table done!----------------------------
Selected table:
Table name: _select_table_30
Records:
File name: student_updated.tbl
Records:
...
Field name: age
Field index for age: 3
Inserting field value: 20 for field: age at index: 3Inserted into _indices[3]: (20, 3)-------------------Table::vector_to_table done!----------------------------
Selected table:
Table name: _select_table_32
Records:
File name: student_updated.tbl
Records:
...
Selected records: 2 3 1 0 

>select * from student where (lname>J or fname=Bo) and (major=CS or major=Art)
Command Function Fired! select * from student where (lname>J or fname=Bo) and (major=CS or major=Art)
set_string Function Fired!
set string : Input string: select * from student where (lname>J or fname=Bo) and (major=CS or major=Art)
Tokenize Function Fired!
Input string: select * from student where (lname>J or fname=Bo) and (major=CS or major=Art)
STokenizer::set_string called with input: select * from student where (lname>J or fname=Bo) and (major=CS or major=Art)
...
Pushing combined token: J
Combining tokens after RELATIONAL_OPERATOR at index 11
Adding token: Bo to combined string.
Pushing combined token: Bo
Combining tokens after RELATIONAL_OPERATOR at index 17
Adding token: CS to combined string.
Pushing combined token: CS
Combining tokens after RELATIONAL_OPERATOR at index 21
Adding token: Art to combined string.
Pushing combined token: Art
Tokens: 
[ALFA: select]
...
>>> Selecting from table: student fields: * 
>>> Applying WHERE condition.
>>> Condition from parse tree: ( lname > J or fname = Bo ) and ( major = CS or major = Art )
>>> Condition string: ( lname > J or fname = Bo ) and ( major = CS or major = Art ) 
Tokenize Function Fired!
Input string: ( lname > J or fname = Bo ) and ( major = CS or major = Art ) 
STokenizer::set_string called with input: ( lname > J or fname = Bo ) and ( major = CS or major = Art ) 
...
Adding token: Bo to combined string.
Pushing combined token: Bo
Combining tokens after RELATIONAL_OPERATOR at index 12
Adding token: CS to combined string.
Pushing combined token: CS
Combining tokens after RELATIONAL_OPERATOR at index 16
Adding token: Art to combined string.
Pushing combined token: Art
Tokens: 
[LeftParen: (]
...
Tokenization done!
Converting Infix to Postfix...
Infix Queue  Queue: head->[LeftParen: (]-> [ALFA: lname]-> [RelationalOperator: >]-> [ALFA: J]-> [LogicalOperator: or]-> [ALFA: fname]-> [RelationalOperator: =]-> [ALFA: Bo]-> [RightParen: )]-> [LogicalOperator: and]-> [LeftParen: (]-> [ALFA: major]-> [RelationalOperator: =]-> [ALFA: CS]-> [LogicalOperator: or]-> [ALFA: major]-> [RelationalOperator: =]-> [ALFA: Art]-> [RightParen: )]-> |||
-------ShuntingYard constructor FIred!-------
-------ShuntingYard::to_postfix Fired!-------
Current Token:--------------> (
Current Token:--------------> lname
...
Current Token:--------------> fname
is string or number
Pushing token: fname to output queue.
Current Token:--------------> =
is operator
Pushing operator: = to stack.
Current Token:--------------> Bo
is string or number
Pushing token: Bo to output queue.
Current Token:--------------> )
右括号情况
Popped left paren from stack.
Current Token:--------------> and
...
右括号情况
Popped left paren from stack.
Postfix Expression: lname J > fname Bo = or major CS = major Art = or and 
-------Table::select fired!-------
-------Table::cond fired!-------
-------Table::field_col_no fired!-------
Field name: lname
...
-------ResultSet::or_with fired!-------
_recnos:0 1 2 3 
Result set after OR operation: 0 1 2 3 -------Table::field_col_no fired!-------
Field name: major
Field map size:4
Field name: major
Field name (ASCII): 109 97 106 111 114 
...
Selected records: 0 1 2 
----- END TEST --------
Test case SQL_BASIC completed successfully!
[       OK ] SQL_BASIC.SQLBasic (114 ms)
[----------] 1 test from SQL_BASIC (114 ms total)
